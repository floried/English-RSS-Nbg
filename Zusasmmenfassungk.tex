...
%	\label{my-label}
	\begin{tabular}{llll}
		\hline
		 \textbf{Natural Disaster}                                           &  \textbf{Causes}                                                                                           &  \textbf{Effects}                                                                                                                                             &  \textbf{Prevention}                                                                                   \\ \hline \hline
...
\begin{itemize}
	\item social welfare: family allowances (Kindergeld), health care, unemployment benefits, pensions
	\item social security: unemployment benefits (\glqq on the dole\glqq) = Hartz IV; disability allowances; family allowances; pensions. 
	\item health care: the National Health Service (doctors, nurses, medicine)
	\item social services: meals-on-wheels, mobility vehicles, social workers, help and support for the elderly or disabled
\end{itemize}
	\subsection{History}
	\begin{itemize}
		\item 1942 William Beveridge recommended the introduction of social security and free care. 
		\item 1946 \underline{N}ational \underline{H}ealth \underline{S}ervice Act: based on the Bevridge Report which said there should be a program of social security for every one from cradle to grave 
...
%	\subitem content: politics, the economy, society, financial news, the arts / literature, sport, TV, weather, obituaries, situations vacant (Jobanzeige)
	...
	\subitem  BBC1, BBC2, ITV, Channel 4, Channel 5, programmes similiar to German TV
	 ...
	 \subitem 9 o'clock watershed = no violent or sex films before 9pm!
\end{itemize}
